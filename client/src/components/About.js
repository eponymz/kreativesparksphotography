    ...
    return (
      <div id="body" className="w-100">
        ...
        <div className="bg-secondary border-dark card card-block card-body m-3">
          ...
          <div
            className="card-dark card-inner card-body"
            style={{
              textAlign: 'left',
              color: 'lightgray',
              fontFamily: "'Monda', sans-serif"
          ...
          >
            ...
            <p>
              Aliquam a velit ex. Aliquam quis blandit eros, eget accumsan
              ipsum. Sed mollis leo ut tempus sodales. Duis ut egestas tortor,
              non posuere augue. In laoreet velit id gravida bibendum. Morbi eu
              ligula purus. Orci varius natoque penatibus et magnis dis
              parturient montes, nascetur ridiculus mus. Duis vehicula tempor
              tortor, et lobortis nibh venenatis vel. Cras vitae magna eros.
              Cras mollis id enim quis venenatis. Pellentesque pulvinar nunc sit
              amet sem convallis, eu porttitor nibh convallis. Suspendisse
              dapibus ut lectus vulputate pretium. Aliquam fringilla vulputate
              metus, in dapibus neque imperdiet eu. Nullam ut elit eget dolor
              vulputate egestas.
            </p>
            <p>
              ...
              consequat mi. Sed dapibus quam a justo venenatis, id finibus
              sapien dictum. Orci varius natoque penatibus et magnis dis
              parturient montes, nascetur ridiculus mus. Nullam viverra massa
              quis auctor porttitor. Nam nec est vitae nunc ultrices hendrerit.
              Aliquam finibus tempus dignissim.
            </p>
            <p>
              ...
              Suspendisse tincidunt enim eros, sit amet scelerisque nisi
              placerat a. Morbi sit amet tellus cursus, fermentum ex et, rutrum
              diam. Nulla nisl nibh, volutpat et velit sit amet, blandit rhoncus
              augue. Vivamus dapibus, erat quis feugiat varius, elit elit dictum
              nibh, id lobortis dolor risus et magna. Mauris dignissim vulputate
              tincidunt. Maecenas a erat vitae massa dapibus cursus nec at
              felis. Maecenas quis ornare felis. Etiam ultricies ante sit amet
              ipsum dapibus, ac mollis arcu luctus.
            </p>
            <p>
              ...
              libero sit amet quam. Ut consequat, leo ut iaculis feugiat, urna
              mi mollis magna, sit amet varius dui massa sed metus. Nulla sit
              amet sem est. Quisque a ante risus. Quisque pulvinar, mauris in
              lobortis egestas, lacus justo egestas nisi, quis egestas ipsum
              elit sed lacus. Aliquam eget venenatis mi, id dignissim justo.
              Nullam mi dui, pulvinar quis dictum sed, lobortis a justo. Morbi
              sed nulla vitae urna malesuada malesuada.
            </p>
            <p>
              Orci varius natoque penatibus et magnis dis parturient montes,
              nascetur ridiculus mus. Curabitur a dictum leo. Etiam lobortis est
